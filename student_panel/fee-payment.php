...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">LBS COLLEGE MANAGEMENT</a>
  ...
  <option value="nu-ukg">BCA 1year</option>
  <option value="nu-ukg">BCA 2year</option>
  <option value="nu-ukg">BCA 3year</option>
  <option value="1">PGDCA</option>
  <option value="2">RSCIT</option>  
  <option value="3">BSc 1year</option>
  <option value="3">BSc 2year</option>
  <option value="3">BSc 3year</option>  
  <option value="3">BA 1year</option>  
  <option value="3">BA 2year</option>  
  <option value="3">BA 3year</option>  
              ...
              <img src="images/QR.jpeg" id="qr" style="height: 100%; width: 100%;">
