                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <select class="form-select" id="class" name="class" style="width:100%;" required>
                                        ...
                                        <option value="11">BSc</option>
                                        <option value="10">PGDCA</option>
                                        <option value="9">BA</option>
                                        <option value="8">RSCIT</option>
                                        ...
                                        <?php
                                            ...
                                            if($row["class"]=="12s"){
                                                echo '<option selected value="'.$row["class"].'">BCA</option>';
                                            }
                                            else if($row["class"]=="12c"){
                                                echo '<option selected value="'.$row["class"].'">BSc</option>';
                                            }
                                           
                                            else if($row["class"]=="11s"){
                                                echo '<option selected value="'.$row["class"].'">BA</option>';
                                            }
                                            else if($row["class"]=="11c"){
                                                echo '<option selected value="'.$row["class"].'">PGDCA</option>';
                                            }
                    ...
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="state" name="state"
                                ...
                                <option value="Panjab">Rajsthan</option>
                                <option value="Gujrat">MP</option>
                            </select>
                            <div class="invalid-feedback">
                                required!
                            </div>
